...
// for (let i = 3; i < arr.length; i++) {
//     if (!(i % 3)) {
//         let candidate = arr[i-1]
//         if(!(candidate%2)){
//             newArr[newArr.length] = candidate
//         }
//     }
// }
// console.log(newArr)
...
//     allPrice += price
// }
// console.log(allPrice/arr.length)

// 7. Створити масив з рандомними значеннями, помножити всі його елементи на 5 та перемістити їх в інший масив.
// let arr = [100, 250, 50, 168, 120, 345, 188];
// let arrX5 = []
// for (const num of arr) {
//     arrX5[arrX5.length] = num*5
// }
// console.log(arrX5)

// 8. Створити масив з будь якими значеннями (стрінги, числа, і тд...). пройтись по ньому, і якщо елемент є числом - додати його в інший масив.
// let arr = ['1',2,4,true,['4',true],9,null,7]
// let numbersArr = []
// for (const item of arr) {
//     if(typeof item === "number"){
//         numbersArr[numbersArr.length] = item
//     }
// }
...
for (const user of usersWithId) {
    for (const city of citiesWithId) {
        if (user['id'] === city['user_id']) {
            ...
            usersWithCities[usersWithCities.length] = newUser
        }
    }
}
...
// let arrNumbersCopy = []
// for (const num of arrNumbers) {
//     arrNumbersCopy[arrNumbersCopy.length] = num
// }
