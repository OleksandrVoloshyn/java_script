...
//     div.innerText = `${value.name} ${value.surname}`
...
//     surname.innerText = value.surname
//     let age = document.createElement('div')
//     age.innerText = value.age
//     let info = document.createElement('div')
//     info.innerText = value.info
//     let photo = document.createElement('img')
//     photo.src = value.photo
//     photo.alt = `${value.name} ${value.surname}`
//
...
coursesArray.forEach(value => {
    ...
    titleH2.classList.add('title','txt_center')
    ...
    monthDiv.classList.add('month','txt_center')
    monthDiv.innerText = `Month Duration: ${value.monthDuration}`

    let hourDiv = document.createElement('div')
    hourDiv.classList.add('hour','txt_center')
    hourDiv.innerText = `Hour Duration: ${value.hourDuration}`
    ...
    wrapDiv.append(titleH2, durationDiv, modulesUl)
